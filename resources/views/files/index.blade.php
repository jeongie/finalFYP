...
<a href="/dashboard" class="custom-btn"><i class="fa fa-home"></i></a>
    ...
    <div class="bg-light p-5 rounded">
      <h3>Files you have uploaded in this session</h3>
      ...
      <br>
      @if(count($saveddbfile) > 0)
        <a href="{{ route('export.excel', ['export_new_files' => true]) }}" class="btn btn-primary float-left mb-3">Export New Files</a>
      @else
        <button class="btn btn-secondary btn-left mb-3" disabled>Export New Files</button>
      @endif
      <br><br>
